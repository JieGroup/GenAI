...
**Acknowledgments**
This course was conceived and developed by Professor  [Jie Ding](https://jding.org/)  of the School of Statistics at the University of Minnesota. The [School of Statistics](https://cla.umn.edu/statistics) and the [Minnesota Supercomputing Institute (MSI)](https://msi.umn.edu/) are acknowledged for their administrative support and provision of computation and educational resources. Special thanks go to  [Xun Xian](https://jeremyxianx.github.io/), [Ganghua Wang](https://gwang.umn.edu/), Jin Du, An Luo, [Xinran Wang](https://wang8740.github.io/), Qi Le, and [Ali Anwar](https://chalianwar.github.io/) at the University of Minnesota, who provided significant contributions to the course design and development.
